...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body mb-4">
            <form action="<?php echo base_url("admin/aspek-penilaian/import") ?>" method="POST" class="mb-4" enctype="multipart/form-data">
                <div class="row">
                    <div class="offset-4 col-md-4">
                        <label for="nama_kelas" class="form-control-label">Sampel Import Data</label>
                        <br>
                        <a href="<?php echo base_url("admin/download-template/aspek-penilaian") ?>" class="btn btn-success btn-block">
...
/*        echo $values;
        ...
        $insert= execute("INSERT INTO aspek_penilaian (nama_indikator, nilai_min, nilai_max, keterangan) VALUES $values");

        if($insert) {
            unlink("../import/".$file_name);
            alert("Data Aspek Penilaian berhasil diimport!", base_url("admin/aspek-penilaian"));
        } else {
            alert("Data Aspek Penilaian gagal diimport!", "back");
        }
